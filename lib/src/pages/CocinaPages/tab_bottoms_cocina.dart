...
class HomePageCocina extends StatefulWidget {
  @override
  _HomePageCocinaState createState() => _HomePageCocinaState();
}

class _HomePageCocinaState extends State<HomePageCocina> {
  List<Widget> pageList = [];

  @override
  void initState() {
    pageList.add(CocinaPage());
