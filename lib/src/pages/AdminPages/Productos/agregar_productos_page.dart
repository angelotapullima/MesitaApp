                            ...
                            Column(
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Center(
                                    child:
                                        Text('Agregar un nuevo producto', style: TextStyle(fontSize: responsive.ip(2.5), color: ColorsApp.greenGrey)),
                                  ),
                                ),
                                Padding(
                                          ...
                                          children: <Widget>[
                                            ...
                                            InkWell(
                                                ...
                                                child: Container(
                                                  ...
                                                  width: responsive.ip(4.5),
                                                  height: responsive.ip(4.5),
                                                  child: Icon(Icons.photo_album), //Image.asset('assets/logo_largo.svg'),
                                                )),
                                          ],
                                        ),
                                      ),
